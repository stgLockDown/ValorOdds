...
export const metadata = {
  title: 'AI Draft Grades — DiamondDraft',
};
    ...
    <>
      ...
      <main className="mx-auto max-w-4xl px-4 py-8">
        <div className="mb-6">
          ...
          <h1 className="text-2xl font-bold text-brand-text mt-1">AI Draft Grades</h1>
          <p className="text-sm text-brand-muted mt-1">
            Every roster graded head-to-head on optimal starting-lineup projections.
          </p>
        </div>
        <GradesClient
          leagueId={league.id}
