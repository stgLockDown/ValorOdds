...
import { Headphones, Code2, FlaskConical, Bell, FileText, Megaphone, Podcast } from 'lucide-react';
  ...
  return (
    <>
      ...
      <main className="container-px mx-auto max-w-7xl py-12 space-y-6">
        ...
        <Link href="/admin/podcast" className="card p-5 flex items-center justify-between hover:border-brand-primary/40 transition-colors group">
          <div className="flex items-center gap-3">
            <Podcast className="h-6 w-6 text-brand-primary" />
            <div>
              <div className="font-semibold group-hover:text-brand-primary transition-colors">Podcast Studio</div>
              <div className="text-sm text-brand-muted">Manage episodes of “Beyond the Odds” — hidden from the public until launch</div>
            </div>
          </div>
          <span className="text-brand-primary text-sm font-semibold">Open →</span>
        </Link>
