...
const DEFAULT_LAYOUTS: ResponsiveLayouts<DefaultBreakpoints> = {
  lg: [
    li(PANEL_KEYS.DRAFT_BOARD, 0, 0, 2, 16, 1, 6),
    li(PANEL_KEYS.MY_ROSTER, 0, 16, 2, 9, 1, 4),
    li(PANEL_KEYS.AVAILABLE_PLAYERS, 2, 0, 1, 16, 1, 6),
    li(PANEL_KEYS.RECENT_PICKS, 2, 16, 1, 6, 1, 3),
  ],
  md: [
    li(PANEL_KEYS.DRAFT_BOARD, 0, 0, 2, 16, 1, 6),
    li(PANEL_KEYS.MY_ROSTER, 0, 16, 2, 9, 1, 4),
  ...
  sm: [
    li(PANEL_KEYS.DRAFT_BOARD, 0, 0, 1, 14, 1, 6),
    li(PANEL_KEYS.MY_ROSTER, 0, 14, 1, 8, 1, 4),
    li(PANEL_KEYS.AVAILABLE_PLAYERS, 0, 22, 1, 14, 1, 6),
    li(PANEL_KEYS.RECENT_PICKS, 0, 36, 1, 5, 1, 3),
  ],
  xs: [
    li(PANEL_KEYS.DRAFT_BOARD, 0, 0, 1, 14, 1, 6),
    li(PANEL_KEYS.MY_ROSTER, 0, 14, 1, 8, 1, 4),
